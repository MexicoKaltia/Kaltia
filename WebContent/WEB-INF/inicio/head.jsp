...
<link href="<s:property value='identidadVO.ambiente'/><s:property value='identidadVO.empresa'/>/images/<s:property value='header.headerSeccion3.get(1)' />?v=1" rel="shortcut icon" type="image/x-icon" />
