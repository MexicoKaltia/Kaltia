		...
		<div class="modal-content"
			...
			<div class="modal-body">
			   ...
			   <div class="form-group row">
		          <span class="col-sm-3 col-form-label text-right colorLabel"><i class="fa fa-2x fa-circle-o bigicon"></i></span>
		          <div class="col-sm-7 colorLabel sizeEtiqueta">
...
<!-- 		              <input id="phone" name="phone" type="text" placeholder="Num Telefono" class="form-control"> -->
		       ...
		       <div class="form-group row">
		          <span class="col-sm-3 col-form-label text-right colorLabel"><i class="fa fa-2x fa-map-marker bigicon"></i></span>
		          <div class="col-sm-7 colorLabel sizeEtiqueta">
