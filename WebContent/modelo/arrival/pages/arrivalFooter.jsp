...
<html lang="">
<body>
<div class="bgded" style="background-image:url('<%=request.getContextPath()%>/empresa/<s:property value='identidadVO.idAction'/>/images/<s:property value='footer.footerSeccion1.get(0)' />');">
    ...
    <div class="wrapper row4">
      <footer id="footer" class="clear"> 
        <div class="one_quarter first">
          ...
          <s:property value='footer.footerSeccion1.get(2)' /><br>
          <s:property value='footer.footerSeccion1.get(3)' /><br>
          <s:property value='footer.footerSeccion1.get(4)' /><br>
          <s:property value='footer.footerSeccion1.get(5)' />
          </address>
          <ul class="nospace">
            <li class="btmspace-10"><i class="fa fa-phone"></i> +<s:property value='footer.footerSeccion1.get(5)' /></li>
      ...
      <p><s:property value='footer.footerSeccion3.get(1)' /></p>
      <p><s:property value='footer.footerSeccion3.get(2)' /></p>
       </footer>
    </div>
    <!-- ################################################################################################ -->
