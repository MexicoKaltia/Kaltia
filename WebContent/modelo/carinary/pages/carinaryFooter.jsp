...
<div class="wrapper row4 bgded overlay" style="background-image:url('<%=request.getContextPath()%>/empresa/<s:property value='identidadVO.idAction'/>/images/<s:property value='footer.footerSeccion1.get(0)'/>');">
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_quarter">
      ...
      <nav>
        <ul class="nospace">
          ...
          <li><a href="#"><s:property value='footer.footerSeccion2.get(1)' /></a></li>
          <li><a href="#"><s:property value='footer.footerSeccion2.get(2)' /></a></li>
          <li><a href="#"><s:property value='footer.footerSeccion2.get(3)' /></a></li>
        </ul>
      </nav>
    ...
    <div class="one_quarter">
      ...
      <article>
        <h2 class="nospace font-x1"><a href="#"><s:property value='footer.footerSeccion3.get(1)' /></a></h2>
        <time class="font-xs" datetime="<s:property value='footer.footerSeccion3.get(1)' />"><s:property value='footer.footerSeccion3.get(1)' /></time>
        <p><s:property value='footer.footerSeccion3.get(3)' /></p>
      </article>
    </div>
        <!-- ################################################################################################ -->
    <div class="one_quarter">
