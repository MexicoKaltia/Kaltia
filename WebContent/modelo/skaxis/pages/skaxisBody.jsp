  ...
  <main class="hoc container clear"> 
    ...
    <article class="group btmspace-80">
      ...
      <div class="one_third">
        ...
        <footer class="nospace"><a class="btn" href="<s:property value='body.bodyTexto1.get(6)'/>"><s:property value='body.bodyTexto1.get(7)'/> &raquo;</a></footer>
      </div>
    </article>
    <!-- ################################################################################################ -->
    ...
    <s:iterator value='body.bodySeccionArray1' var='bodySeccionArray1'>
      <li class="one_third">
        <article><a href="#"><img src="<%=request.getContextPath()%>/empresa/<s:property value='identidadVO.idAction'/>/images/<s:property value='#bodySeccionArray1.objetoVO.get(0)' />" alt=""></a>
          <h6 class="heading"><s:property value='#bodySeccionArray1.objetoVO.get(1)' /></h6>
          <ul class="nospace meta">
            <li><i class="fa fa-user"></i> <a href="#"><s:property value='#bodySeccionArray1.objetoVO.get(2)' /></a></li>
            <li><i class="fa fa-tag"></i> <a href="#"><s:property value='#bodySeccionArray1.objetoVO.get(3)' /></a></li>
          </ul>
          <p><s:property value='#bodySeccionArray1.objetoVO.get(4)' /></p>
          <footer class="nospace"><a class="btn" href="<s:property value='#bodySeccionArray1.objetoVO.get(5)' />"><s:property value='#bodySeccionArray1.objetoVO.get(6)' /> &raquo;</a></footer>
        </article>
      </li>
     </s:iterator>
    </ul>
...
<div class="wrapper bgded overlay coloured" style="background-image:url('<%=request.getContextPath()%>/empresa/<s:property value='identidadVO.idAction'/>/images/<s:property value='body.bodyTexto2.get(0)'/>');">
  <article class="hoc cta clear"> 
    ...
    <footer class="one_quarter"><a class="btn" href="<s:property value='body.bodyTexto2.get(2)'/>"><s:property value='body.bodyTexto2.get(3)'/> &raquo;</a></footer>
  </article>
</div>
<!-- ################################################################################################ -->
</body>
