  ...
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_quarter first">
      ...
      <ul class="nospace btmspace-30 linklist contact">
        ...
        <li><i class="fa fa-phone"></i><s:property value='footer.footerSeccion1.get(2)' /></li>
        <li><i class="fa fa-envelope-o"></i><s:property value='footer.footerSeccion1.get(3)' /></li>
        <li>
    ...
    <!-- ################################################################################################ -->
    <div class="one_quarter">
      <h6 class="heading"><s:property value='footer.footerSeccion5.get(0)' /></h6>
      <p class="nospace btmspace-15"><s:property value='footer.footerSeccion5.get(1)' /></p>
      <p class="nospace btmspace-15"><s:property value='footer.footerSeccion5.get(2)' /></p>
      <form method="post" action="<s:property value='footer.footerSeccion5.get(3)' />">
        <fieldset>
          <legend>Newsletter:</legend>
          <input class="btmspace-15" type="text" value="" placeholder="Name">
          <input class="btmspace-15" type="text" value="" placeholder="Email">
          <button type="submit" value="submit"><s:property value='footer.footerSeccion5.get(4)' /></button>
        </fieldset>
      </form>
    </div>
  </footer>
