  ...
  <main class="container clear"> 
    ...
    <div class="group">
      ...
      <div class="two_third">
        ...
        <p class="btmspace-80"><s:property value='body.bodySeccionArray1.get(0).objetoVO.get(2)' /></p>
        <ul class="nospace group">
		    ...
		    <s:iterator var="bodySeccionArray1">
        	  <li class="<s:property value='#bodySeccionArray1.objetoVO.get(0)'/>">
            	<h6 class="nospace btmspace-10"><a href="<s:property value='#bodySeccionArray1.objetoVO.get(1)'/>"><i class="<s:property value='#bodySeccionArray1.objetoVO.get(2)'/>"></i>
...
<div class="wrapper row4">
  <section id="info" class="clear"> 
    <div class="center btmspace-80">
      <h2 class="heading uppercase btmspace-30"><s:property value='body.bodySeccionArray1.get(0).objetoVO.get(1)' /></h2>
      <p class="lrspace"><s:property value='body.bodySeccionArray1.get(0).objetoVO.get(2)' /></p>
    </div>
    <div class="group">
      <div class="one_half first"><img class="borderedbox inspace-10" src="<%=request.getContextPath()%>/empresa/<s:property value='identidadVO.idAction'/>/images/<s:property value='body.bodySeccionArray1.get(0).objetoVO.get(0)' />" alt="<s:property value='identidadVO.idAction'/>"></div>
      <div class="one_half">
        <ul class="nospace group services">
            <s:subset start="1" source ="body.bodySeccionArray2">
		    <s:iterator var="bodySeccionArray2">        
          <li>
            <article><a href="<s:property value='#bodySeccionArray2.objetoVO.get(0)'/>">
            <i class="<s:property value='#bodySeccionArray2.objetoVO.get(1)'/>"></i></a>
              ...
              <footer><a href="#"><s:property value='#bodySeccionArray2.objetoVO.get(4)'/> &raquo;</a></footer>
            </article>
          </li>
          </s:iterator>
          </s:subset>
