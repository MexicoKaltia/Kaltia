...
<div class="wrapper row5">
  <footer id="footer" class="clear"> 
    <div class="one_quarter first">
      ...
      <ul class="nospace">
        <li class="btmspace-10"><span class="fa fa-phone"></span><s:property value='footer.footerSeccion1.get(2)' /></li>
        <li><span class="fa fa-envelope-o"></span> <s:property value='footer.footerSeccion1.get(3)' /></li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
    ...
    <div class="one_quarter">
      ...
      <form method="post" action="<s:property value='identidadVO.idAction'/>/<s:property value='footer.footerSeccion5.get(2)' />">
        <fieldset>
          ...
          <button type="submit" value="submit"><s:property value='footer.footerSeccion5.get(3)' /></button>
        </fieldset>
      </form>
    </div>
  </footer>
