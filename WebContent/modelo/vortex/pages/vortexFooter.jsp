...
<div class="wrapper row4">
  <footer id="footer" class="clear"> 
    ...
    <div class="one_third first">
      ...
      <s:property value="footer.footerSeccion1.get(1)"/><br>
      <s:property value="footer.footerSeccion1.get(2)"/><br>
      <s:property value="footer.footerSeccion1.get(3)"/>
      </address>
      <ul class="nospace">
        <li class="push10"><span class="icon-time"></span><s:property value="footer.footerSeccion1.get(4)"/></li>
        <li class="push10"><span class="icon-phone"></span><s:property value="footer.footerSeccion1.get(5)"/></li>
        <li><span class="icon-envelope-alt"></span><s:property value="footer.footerSeccion1.get(6)"/></li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
    <div class="one_third">
