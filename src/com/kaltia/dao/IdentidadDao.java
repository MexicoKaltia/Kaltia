	...
	public BodyVO qryElementoBody(String action, String elementoPagina) throws SQLException {
		...
		try {
			...
			*/	
				...
				bodyVO.setBodyTexto1(returnDAO.get(3)!= null ? ComunResolution.arrayUno(returnDAO.get(3).toString(), ComunResolution.tokenUno) : new ArrayList<String>());				
				bodyVO.setBodyTexto2(returnDAO.get(4)!= null ? ComunResolution.arrayUno(returnDAO.get(4).toString(),ComunResolution.tokenUno) : new ArrayList<String>());
				bodyVO.setBodyTexto3(returnDAO.get(5)!= null ? ComunResolution.arrayUno(returnDAO.get(5).toString(),ComunResolution.tokenUno) : new ArrayList<String>());
				bodyVO.setBodyTexto4(returnDAO.get(6)!= null ? ComunResolution.arrayUno(returnDAO.get(6).toString(),ComunResolution.tokenUno) : new ArrayList<String>());
				bodyVO.setBodyTexto5(returnDAO.get(7)!= null ? ComunResolution.arrayUno(returnDAO.get(7).toString(),ComunResolution.tokenUno) : new ArrayList<String>());
				bodyVO.setBodyTexto6(returnDAO.get(8)!= null ? ComunResolution.arrayUno(returnDAO.get(8).toString(),ComunResolution.tokenUno) : new ArrayList<String>());
				bodyVO.setBodyTexto7(returnDAO.get(9)!= null ? ComunResolution.arrayUno(returnDAO.get(9).toString(),ComunResolution.tokenUno) : new ArrayList<String>());
				bodyVO.setBodyTexto8(returnDAO.get(10)!= null ? ComunResolution.arrayUno(returnDAO.get(10).toString(),ComunResolution.tokenUno) : new ArrayList<String>());
				bodyVO.setBodyTexto9(returnDAO.get(11)!= null ? ComunResolution.arrayUno(returnDAO.get(11).toString(),ComunResolution.tokenUno) : new ArrayList<String>());
				bodyVO.setBodyTexto10(returnDAO.get(12)!= null ? ComunResolution.arrayUno(returnDAO.get(12).toString(),ComunResolution.tokenUno) : new ArrayList<String>());
	...
	public FooterVO qryElementoFooter(String action) throws SQLException {
		...
		try {
			...
			*/	
				...
				footerVO.setFooterLista1(returnDAO.get(2) != null ? ComunResolution.arrayUno(returnDAO.get(2).toString(), ComunResolution.tokenUno) : new ArrayList<String>());
				footerVO.setFooterLista2(returnDAO.get(3) != null ? ComunResolution.arrayUno(returnDAO.get(3).toString(), ComunResolution.tokenUno) : new ArrayList<String>());
				footerVO.setFooterLista3(returnDAO.get(4) != null ? ComunResolution.arrayUno(returnDAO.get(4).toString(), ComunResolution.tokenUno) : new ArrayList<String>());
				footerVO.setFooterLista4(returnDAO.get(5) != null ? ComunResolution.arrayUno(returnDAO.get(5).toString(), ComunResolution.tokenUno) : new ArrayList<String>());
				footerVO.setFooterLista5(returnDAO.get(6) != null ? ComunResolution.arrayUno(returnDAO.get(6).toString(), ComunResolution.tokenUno) : new ArrayList<String>());
